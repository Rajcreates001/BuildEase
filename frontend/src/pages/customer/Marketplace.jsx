        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex border border-gray-600 rounded-lg p-1">
            <button onClick={() => setBrand('indian')}
              className={`px-4 py-1 rounded-md text-sm font-semibold transition ${brand === 'indian' ? 'bg-yellow-400 text-gray-900' : 'text-gray-300'}`}>
              Indian Brands
            </button>
            <button onClick={() => setBrand('foreign')}
              className={`px-4 py-1 rounded-md text-sm font-semibold transition ${brand === 'foreign' ? 'bg-yellow-400 text-gray-900' : 'text-gray-300'}`}>
              Foreign Brands
            </button>
          </div>
        </div>
