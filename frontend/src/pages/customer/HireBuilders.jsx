  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 mb-4 pb-4 border-b border-gray-800">
        <span className="text-sm text-gray-400">Filter by Specialization:</span>
        {filters.map((f) => (
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {contractors.length === 0 ? (
            ...
            contractors.map((c) => (
              <GlassCard key={c._id} className="p-4 flex flex-wrap items-center justify-between gap-4">
                <div>
                ...
                <div className="flex gap-2">
                  <button className="px-4 py-2 bg-white/10 text-white font-semibold rounded-lg hover:bg-white/20">View Profile</button>
                  <button className="px-4 py-2 btn-primary text-gray-900 font-semibold rounded-lg">Request Quote</button>
                </div>
              </GlassCard>
            ))
          )}
